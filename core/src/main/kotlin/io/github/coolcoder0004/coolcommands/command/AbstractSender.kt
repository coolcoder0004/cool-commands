...
public abstract class AbstractSender(
    ...
    public override val language: Language
        get() = languageService.getLanguage(this)

    public override fun sendTemplatedMessage(templatedMessage: String) =
        sendMessage(templateInjector.inject(language, templatedMessage))
}
